...
begin
    ShowMessage('Caso haja dúvida, informações incorretas ou encontre algum erro em alguma parte da nossa plataforma, por gentileza, entre em contado com o suporte da empresa');
...
//Cancela o que está sendo digitado
...
//Exclução dos dados que estão na tabela
procedure TfrmCidades.btnExcluirClick(Sender: TObject);

begin
    if (Application.MessageBox('Você confirma a exclução?' , 'AVISO' , MB_ICONQUESTION+MB_YESNO) = idNo) then
        EXIT;
