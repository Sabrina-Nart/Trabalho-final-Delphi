...
procedure TfrmClientes.BitBtn_CancelarClick(Sender: TObject);

begin
    DataSource_Clientes2.DataSet.Cancel;
...
procedure TfrmClientes.BitBtn_SalvarClick(Sender: TObject);

begin
    DataSource_Clientes2.DataSet.Post
end;
